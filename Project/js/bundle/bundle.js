...
window.addEventListener('DOMContentLoaded', function(){
	...
	let modalWindow = require('../parts/modalWindow.js');
	let modalForms = require('../parts/modalForms.js');
	let timer = require('../parts/timer.js');
	let tab = require('../parts/tab.js');
	let calc = require('../parts/calc.js');
	let galery = require('../parts/galery.js');
...
},{"../parts/calc.js":2,"../parts/galery.js":3,"../parts/modalForms.js":4,"../parts/modalWindow.js":5,"../parts/tab.js":6,"../parts/timer.js":7}],2:[function(require,module,exports){
function calc() {
  //Calc
  ...
  icons_img = [], next_btn = calc.getElementsByClassName('button')[0], calc_profile = document.getElementsByClassName('popup_calc_profile')[0], profile_calc_close = document.getElementsByClassName('popup_calc_profile_close')[0], checkbox_profile = calc_profile.getElementsByClassName('checkbox-custom'), checkbox_label = calc_profile.getElementsByTagName('label'), calc_profile_types = calc_profile.getElementsByTagName('options'), select_profile = calc_profile.getElementsByTagName('select')[0], next_btn_profile = calc_profile.getElementsByClassName('button')[0], calc_end = document.getElementsByClassName('popup_calc_end')[0], calc_options = {
    name,
    telephone: '',
    balconType: "type1",
    width,
